package com.example.andie.mastermind.UIComponents.UIComponents.Adapter;
...
public class AttemptListAdapter extends BaseAdapter {
    ...
    int num_pin = 4;
    ArrayList<PinColorList> guessAttemptList;
    ...
    public void setGameData(int num, ArrayList<PinColorList> guessList, ArrayList<Hint> hintList) {
        this.num_pin = num;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        PinColorList pArr = (PinColorList) getItem(position);
        PinColor[] pinArrRow = pArr.getPinArray();
        Hint hList = getHintItem(position);
        List<HintSymbol> hArrayList = hList.getList();

        for(int i = 0; i<num_pin; i++){
            String drawableName = pinArrRow[i].getDrawableName();
